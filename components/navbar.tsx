  ...
  return (
    <div className="flex w-full justify-between  h-16 shadow-md fixed z-20  backdrop-blur-lg bg-black bg-opacity-60">
      ...
      <div className="items-center flex mx-2">
        <ul className="flex">
          <Link href="/community">
            <li className={pathname === "/community" ? IS_ACTIVE : INACTIVE}>
              <img
                className="w-6"
          ...
          <Link href="/resources">
            <li className={pathname === "/resources" ? IS_ACTIVE : INACTIVE}>
              <img
                className="w-6"
        ...
        {session.data ? (
          <div>
            ...
            <Button
              ...
              className="hover:bg-[#99FBFF] hover:text-black bg-[#023262] transition-all duration-300 mx-2"
            >
              logout
            </Button>
          </div>
          ...
          <div>
            ...
            <Link href="/register">
              <Button className="hover:bg-[#99FBFF] hover:text-black bg-[#023262] transition-all duration-300 mx-2">
                Register
              </Button>
            </Link>
          </div>
