...
const ACTIVE =
  "h-12 font-bold my-1 bg-slate-200 rounded-lg p-2 flex items-center";
const INACTIVE =
  ...
  return (
    <div className="w-[25%] flex flex-col">
        ...
        {pathname === "/dashboard/polls" ? (
          ...
          <Link href="/dashboard/polls">
            <div className={INACTIVE}>
              <img
                className="w-6"
                src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'%3E%3Cpath fill='white' d='M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2m0 16H5V5h14zM7 10h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z'/%3E%3C/svg%3E"
                alt=""
              />
              <p className="ml-2">Polls</p>
            </div>
      ...
      <div className="p-6">
        ...
        <div className="h-12 text-slate-300 flex justify-between items-center border rounded-xl p-4">
          <p>Show more</p>
          <svg
            className="w-8"
