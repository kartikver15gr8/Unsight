  ...
  return (
    <div className="w-full flex flex-col bg-gray-900  ">
      <div className="flex flex-row justify-center w-[100%]">
        <div className="text-white items-center flex flex-col p-4 ml-4 my-8 ">
          <h1 className="text-3xl font-bold mb-4">Join Unsight Community!</h1>
          <p className="text-lg  text-slate-400  ">
            Join a simple initiative to connect students all across the globe,
          </p>
      ...
      <div className="border-t border-[#1F72AF] w-[100%] text-[#1F72AF] flex flex-col  items-center py-10  ">
        <div className="flex items-center ml-8 hover:cursor-pointer ">
          ...
          <p className="mr-4 hover:text-blue-100 transition-all duration-200">
            2024 Unsight, Inc
          </p>
          <p className="mx-4 hover:text-blue-100 transition-all duration-200">
            Terms
          </p>
          <p className="mx-4 hover:text-blue-100 transition-all duration-200">
            Privacy
        ...
        <div className="mx-4 flex hover:cursor-pointer my-8">
          <a
            href="https://x.com/kartikeystack"
            target="_blank"
            className="w-14 mx-4 hover:scale-110 transition-all duration-150"
          >
          ...
          <a
            href="https://github.com/kartikver15gr8"
            target="_blank"
            className="w-14 mx-4 hover:scale-110 transition-all duration-150"
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
